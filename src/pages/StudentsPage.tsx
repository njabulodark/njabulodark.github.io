          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* <div className="group relative overflow-hidden rounded-xl shadow-lg h-64 cursor-pointer">
              <img 
                ...
                alt="Students at Desks" 
                className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                <span className="text-white font-medium flex items-center gap-2"><BookOpen size={18}/> Academics</span>
              </div>
            </div>
            ...
            {/* <div className="group relative overflow-hidden rounded-xl shadow-lg h-64 cursor-pointer">
              <img 
                src="https://images.unsplash.com/photo-1564951434112-64d74cc2a2d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                alt="Students Outdoors" 
                className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                <span className="text-white font-medium flex items-center gap-2"><Tent size={18}/> Outdoors</span>
              </div>
            </div> */}
            ...
            {/*<div className="group relative overflow-hidden rounded-xl shadow-lg h-64 cursor-pointer">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-4">
                <span className="text-white font-medium flex items-center gap-2"><Camera size={18}/> Portraits</span>
              </div>
            </div> */}
